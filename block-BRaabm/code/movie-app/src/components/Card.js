...
class Card extends React.Component {
    ...
    render() {
        ...
        return (
                    ...
                    return (
                        <div className="w-2/6 mb-10 flex flex-col items-center card" key={i} onMouseOver={() => this.handleMouseOver(i)} onMouseLeave = {() => this.handleMouseLeave(i)}>
                            <div className="flex mr-10 text-center">
                                <img src={movie.Images[0]} alt={movie.Title} className="w-full h-full"/>
                            </div>
            ...
            <section className={this.state.selectedIndex && !this.state.modalClose ?  "w-custom bg-green-100 top-16 fixed mr-40 left-40 p-8 overflow-scroll bottom-12 rounded-lg": "hidden"}>
