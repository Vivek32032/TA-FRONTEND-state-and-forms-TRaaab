        ...
        <>
        {
            allQuestions.map((question, i) => {
                return (
                    ...
                    <h2 className={this.state.activeQuestion === i ? "bg-green-500" : "bg-red-300" } onClick={() => {
                                this.setState({
                                   activeQuestion: this.state.activeQuestion === i ? null : i
                                })
                            }}>{question.Q} <i className={this.state.activeQuestion === i ? "fas fa-angle-up": "fas fa-angle-down"}></i></h2>
